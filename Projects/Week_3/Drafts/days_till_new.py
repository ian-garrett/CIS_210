...
def count_days_newyear(start_month, start_day, end_month, end_day, year):
...
def count_days_main(year,start_month, start_day, end_month, end_day):
    ...
    if detect_newyear(start_month, start_day, end_month, end_day) is True: # if a new year is detected between the two dates, call count_days_newyeas
    		count_days_newyear(start_month, end_day, end_month, end_day) # function to calculate days between dates of different years
