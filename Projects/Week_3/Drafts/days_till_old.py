...
def count_days_main(year,month_1, day_1, month_2, day_2):
    ...
    if detect_newyear(month_1, day_1, month_2, day_2) is True:
    		count_days_newyear(month_1, day_2, month_2, day_2)
    else:
    		#counts days for two dates in the same year
            for i in range (month_1):
            	day_count_1 += active_months[i] #add up days for each month
            day_count_1 += day_1  #adds days from partial month
            for i in range (month_2):
            	day_count_2 += active_months[i] #adds up days to second month
            day_count_2 += day_2 #adds days from partial second month
